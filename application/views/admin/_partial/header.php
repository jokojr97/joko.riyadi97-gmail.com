...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-success bg-orange">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="<?= base_url() ?>" class="brand-link  bg-dark">
     <!--  <img src="<?= base_url() ?>assets/iconhead.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
      ...
      <span class="brand-text font-weight text-orange text-bold" style="font-size: 25px">WebGIS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link <?php  if($this->session->flashdata('menu') == "berita"){echo "active";} ?>">
